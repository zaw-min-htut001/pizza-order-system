                ...
                <form action=" {{ route('user#edit',Auth::user()->id) }} " method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="image col-3 offset-2 me-5 ">
                            ...
                            @if (Auth::user()->gender == 'male') <img src="{{asset('image/'.'images (1).jpeg')}}" alt="" class="img-thumbnail shadow-sm">
                        @else <img src="{{asset('image/'.'images.jpeg')}}" alt="" class="img-thumbnail shadow-sm"> @endif
                            @else
                        ...
                        <div class="col-5  ">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="address" id="" cols="30" rows="10" placeholder="Enter Admin Address...">{{Auth::user()->address}}</textarea>
                                    @error("address")
                                        <div class="invalid-feedback"> {{ $message }}</div>
                                    @enderror
                                </div>
